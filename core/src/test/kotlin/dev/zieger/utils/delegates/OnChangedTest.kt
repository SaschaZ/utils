...
import dev.zieger.utils.delegates.OnChangedTest.OnChangedResultsNew.OnChangedTestResultOutput
...
class OnChangedTest {
        ...
        parameterMixCollect(
            ...
            repeat(200) { i ->
                ...
                testProperty = TestValueContainer(newValue, i).apply {
                    results.offer(OnChangedResultsNew.OnChangedTestResultInput(this, newVeto, newClearCache))
                }
            }
    ...
    private suspend fun Map<OnChangedParams, Channel<OnChangedResultsNew>>.verify() {
        ...
        for ((input, result) in this) {
            ...
            var directInput = OnChangedResultsNew.OnChangedTestResultInput(TestValueContainer(), false, false)
            ...
            result.toList()/*.sortedBy { it.onChangedScope.value.idx }*/.forEach { r ->
                when (r) {
                    is OnChangedResultsNew.OnChangedTestResultInput -> {
                        println(r)
