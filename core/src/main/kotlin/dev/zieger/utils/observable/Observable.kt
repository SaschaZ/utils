...
open class Observable2<P : Any?, T : Any?>(
    ...
    constructor(initial: T, onChanged: IOnChangedScope2<P, T>.(T) -> Unit = {}) :
            this(ObservableParams2(initial, scopeFactory = OnChangedScope2Factory(), onChanged = onChanged))
}
...
typealias IObservableParams<T> = IObservableParams2<Any?, T>
