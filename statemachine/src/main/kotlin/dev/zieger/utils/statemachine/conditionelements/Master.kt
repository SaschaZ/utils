...
open class Event(
    ...
    override fun toString(): String = "E(${this::class.simpleName})"
...
open class State : AbsState {
    ...
    override fun toString(): String = "S(${this::class.simpleName})"
...
open class EventGroup<T : AbsEvent>(
    ...
    override fun toString(): String = "Eg(${groupType.simpleName})"
}
...
open class StateGroup<T : AbsState>(
    ...
    override fun toString(): String = "Sg(${groupType.simpleName})"
}